...
presupuesto = st.sidebar.slider("Presupuesto", 10000000000, 45000000000, 20000000000)
...
impacto = b0 + prep_alumno*b1[0] + presupuesto_infra/10000000000*0.15 + presupuesto_docentes/10000000000*.14
